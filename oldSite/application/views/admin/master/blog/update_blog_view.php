<aside class="right-side"> 
    <section class="content"> 
        <div class="row">
            <div class="col-md-12">
                <div class="headr-sec alert-info"> 
                    <span class="header">Update Blog </span> 
                    <span class="header pull-right"> 
                        <a style="color: white;" href="<?PHP echo base_url(); ?>admin/master/blogView">
        ...
        <div class="container top-space1">
            <div class="row">
                <div class="col-md-12">
                    <form role="form" id="update_blog">
                        <input type="hidden" class="form-control noradius" name="blog_id" id="blog_id" value="<?PHP echo $blogDetails[0]['blog_id']; ?>" />
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="exampleInputEmail1" class="usernamepopup">Title</label>
                                <input type="text" class="form-control noradius" name="title" id="title" value="<?PHP echo $blogDetails[0]['title']; ?>" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="hidden" id="image_name_edit" name="image_name_edit" value="<?PHP echo $blogDetails[0]['image_name']; ?>"/>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="exampleInputEmail1" class="usernamepopup">Description</label>
                                <textarea name="description" id="description" cols="50" rows="4" class="form-control ckeditor"><?PHP echo $blogDetails[0]['description']; ?></textarea>
    ...
    $(document).ready(function () {
        $("#update_blog").on('submit', (function (e) {
            ...
            if (hasError == 1) {
                ...
                e.preventDefault();
                $.ajax({
                    url: "<?php echo base_url(); ?>admin/master/updateBlogDetails",
                    type: "POST",
                    ...
                    success: function (msg){
                        window.location = "<?php echo base_url(); ?>admin/master/blogView";
                    }
                });
                return false;
            }

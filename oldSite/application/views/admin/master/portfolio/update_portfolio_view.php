<aside class="right-side"> 
    <section class="content"> 
        <div class="row">
            <div class="col-md-12">
                <div class="headr-sec alert-info"> 
                    <span class="header">Update Portfolio </span> 
        ...
        <div class="container top-space1">
            <div class="row">
                <div class="col-md-12">
                    <form role="form" id="update_portfolio">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control noradius" name="title" id="title" value="<?PHP echo $portfolioDetails[0]['title']; ?>" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="exampleInputEmail1" class="usernamepopup">App Link</label>
                                <input type="text" class="form-control noradius" name="app_link" id="app_link" value="<?PHP echo $portfolioDetails[0]['app_link']; ?>" />
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="hidden" id="image_name_edit" name="image_name_edit" value="<?PHP echo $portfolioDetails[0]['image_name']; ?>"/>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="exampleInputEmail1" class="usernamepopup">Description</label>
                                <textarea name="description" id="description" cols="50" rows="4" class="form-control ckeditor"><?PHP echo $portfolioDetails[0]['description']; ?></textarea>

...
\YoastSEO_Vendor\ORM::configure('sqlite:./demo.sqlite');
...
$db = \YoastSEO_Vendor\ORM::get_db();
$db->exec("\n        CREATE TABLE IF NOT EXISTS contact (\n            id INTEGER PRIMARY KEY, \n            name TEXT, \n            email TEXT \n        );");
// Handle POST submission
if (!empty($_POST)) {
    // Create a new contact object
    $contact = \YoastSEO_Vendor\ORM::for_table('contact')->create();
...
$count = \YoastSEO_Vendor\ORM::for_table('contact')->count();
$contact_list = \YoastSEO_Vendor\ORM::for_table('contact')->find_many();
?>

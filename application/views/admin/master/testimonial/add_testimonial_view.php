<aside class="right-side"> 
    <section class="content"> 
        <div class="row">
            <div class="col-md-12">
                <div class="headr-sec alert-info"> 
                    <span class="header">Add Testimonial </span> 
        ...
        <div class="container top-space1">
            <div class="row">
                <div class="col-md-12">
                    <form role="form" id="save_testimonial">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="exampleInputEmail1" class="usernamepopup">Title</label>
                                <input type="text" class="form-control noradius" name="user_name" id="user_name">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="exampleInputEmail1" class="usernamepopup">Company Name</label>
                                <input type="text" class="form-control noradius" name="company_name" id="company_name">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
    ...
    $(document).ready(function () {
        $("#save_testimonial").on('submit', (function (e) {
            ...
            if (hasError == 1) {
                ...
                e.preventDefault();
                $.ajax({
                    url: "<?php echo base_url(); ?>admin/master/saveTestimonialDetails",
                    type: "POST",
